...
public class Connectivity {
    ...
    public static boolean isConnectionFast(int type, int subType) {
        if (type == ConnectivityManager.TYPE_WIFI) {
            Log.e("Network Type","TYPE_WIFI");
            return true;
        } else if (type == ConnectivityManager.TYPE_MOBILE) {
            switch (subType) {
                case TelephonyManager.NETWORK_TYPE_1xRTT:
                    Log.e("Network Type","NETWORK_TYPE_1xRTT");
                    return true; // ~ 50-100 kbps
                case TelephonyManager.NETWORK_TYPE_CDMA:
                    Log.e("Network Type","NETWORK_TYPE_CDMA");
                    return true; // ~ 14-64 kbps
                case TelephonyManager.NETWORK_TYPE_EDGE:
                    Log.e("Network Type","NETWORK_TYPE_EDGE");
                    return true; // ~ 50-100 kbps
                case TelephonyManager.NETWORK_TYPE_EVDO_0:
                    Log.e("Network Type","NETWORK_TYPE_EVDO_0");
                    return true; // ~ 400-1000 kbps
                case TelephonyManager.NETWORK_TYPE_EVDO_A:
                    Log.e("Network Type","NETWORK_TYPE_EVDO_A");
                    return true; // ~ 600-1400 kbps
                case TelephonyManager.NETWORK_TYPE_GPRS:
                    Log.e("Network Type","NETWORK_TYPE_GPRS");
                    return true; // ~ 100 kbps
                case TelephonyManager.NETWORK_TYPE_HSDPA:
                    Log.e("Network Type","NETWORK_TYPE_HSDPA");
                    return true; // ~ 2-14 Mbps
                case TelephonyManager.NETWORK_TYPE_HSPA:
                    Log.e("Network Type","NETWORK_TYPE_HSPA");
                    return true; // ~ 700-1700 kbps
                case TelephonyManager.NETWORK_TYPE_HSUPA:
                    Log.e("Network Type","NETWORK_TYPE_HSUPA");
                    return true; // ~ 1-23 Mbps
                case TelephonyManager.NETWORK_TYPE_UMTS:
                    Log.e("Network Type","NETWORK_TYPE_UMTS");
                ...
                case TelephonyManager.NETWORK_TYPE_EHRPD: // API level 11
                    Log.e("Network Type","NETWORK_TYPE_EHRPD");
                    return true; // ~ 1-2 Mbps
                case TelephonyManager.NETWORK_TYPE_EVDO_B: // API level 9
                    Log.e("Network Type","NETWORK_TYPE_EVDO_B");
                    return true; // ~ 5 Mbps
                case TelephonyManager.NETWORK_TYPE_HSPAP: // API level 13
                    Log.e("Network Type","NETWORK_TYPE_HSPAP");
                    return true; // ~ 10-20 Mbps
                case TelephonyManager.NETWORK_TYPE_IDEN: // API level 8
                    Log.e("Network Type","NETWORK_TYPE_IDEN");
                    return false; // ~25 kbps
                case TelephonyManager.NETWORK_TYPE_LTE: // API level 11
                    Log.e("Network Type","NETWORK_TYPE_LTE");
                    return true; // ~ 10+ Mbps
                // Unknown
                case TelephonyManager.NETWORK_TYPE_UNKNOWN:
                    Log.e("Network Type","NETWORK_TYPE_UNKNOWN");
                default:
                    return false;
            }
        } else {
